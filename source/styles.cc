...
X_scale_style sca_dBsm, sca_dBsh, sca_dBlg, sca_Tatt, sca_Patt, sca_0_12,
		sca_Tu1, sca_Tu2, sca_Tu3, sca_Tu4;
X_scale_style sca_azim, sca_difg, sca_size, sca_trev, sca_spos, sca_Tfr,
		sca_Tmd, sca_Swl;
...
void init_styles(X_display *disp, X_resman *xrm) {
	...
	XftColors.spla_fg = disp->alloc_xftcolor(xrm->get(".color.spla.fg", "blue"),
			XftColors.black);
	XftColors.main_fg = disp->alloc_xftcolor(
			xrm->get(".color.main.fg", "white"), XftColors.black);
	XftColors.text_fg = disp->alloc_xftcolor(
			xrm->get(".color.text.fg", "black"), XftColors.black);
	XftColors.butt_fg0 = disp->alloc_xftcolor(
			xrm->get(".color.butt.fg0", "white"), XftColors.white);
	XftColors.butt_fg1 = disp->alloc_xftcolor(
			xrm->get(".color.butt.fg1", "black"), XftColors.black);
	XftColors.ife0_fg0 = disp->alloc_xftcolor(
			xrm->get(".color.ife0.fg0", "white"), XftColors.white);
	XftColors.ife0_fg1 = disp->alloc_xftcolor(
			xrm->get(".color.ife0.fg1", "black"), XftColors.black);
	XftColors.ife1_fg0 = disp->alloc_xftcolor(
			xrm->get(".color.ife1.fg0", "white"), XftColors.white);
	XftColors.ife1_fg1 = disp->alloc_xftcolor(
			xrm->get(".color.ife1.fg1", "black"), XftColors.black);
	XftColors.ife2_fg0 = disp->alloc_xftcolor(
			xrm->get(".color.ife2.fg0", "white"), XftColors.white);
	XftColors.ife2_fg1 = disp->alloc_xftcolor(
			xrm->get(".color.ife2.fg1", "black"), XftColors.black);
	XftColors.ife3_fg0 = disp->alloc_xftcolor(
			xrm->get(".color.ife3.fg0", "white"), XftColors.white);
	XftColors.ife3_fg1 = disp->alloc_xftcolor(
			xrm->get(".color.ife3.fg1", "black"), XftColors.black);
	XftColors.func_d0 = disp->alloc_xftcolor(
			xrm->get(".color.func.d0", "gray50"), XftColors.black);
	XftColors.func_d1 = disp->alloc_xftcolor(
			xrm->get(".color.func.d1", "yellow"), XftColors.black);
	XftColors.func_d2 = disp->alloc_xftcolor(
			xrm->get(".color.func.d2", "green"), XftColors.black);
	XftColors.midi_fg = disp->alloc_xftcolor(
			xrm->get(".color.midi.fg", "white"), XftColors.black);

	Colors.black = disp->blackpixel();
	Colors.white = disp->whitepixel();
	Colors.spla_bg = disp->alloc_color(xrm->get(".color.spla.bg", "white"),
			Colors.white);
	Colors.main_bg = disp->alloc_color(xrm->get(".color.main.bg", "gray40"),
			Colors.black);
	Colors.main_ds = disp->alloc_color(xrm->get(".color.main.ds", "gray20"),
			Colors.black);
	Colors.main_ls = disp->alloc_color(xrm->get(".color.main.ls", "gray60"),
			Colors.white);
	Colors.text_bg = disp->alloc_color(xrm->get(".color.text.bg", "gray80"),
			Colors.white);
	Colors.text_hl = disp->alloc_color(xrm->get(".color.text.hl", "white"),
			Colors.white);
	Colors.text_ca = disp->alloc_color(xrm->get(".color.text.ca", "red"),
			Colors.black);
	Colors.slid_kn = disp->alloc_color(xrm->get(".color.slid.kn", "coral"),
			Colors.black);
	Colors.slid_mk = disp->alloc_color(xrm->get(".color.slid.mk", "white"),
			Colors.white);
	Colors.butt_bg0 = disp->alloc_color(xrm->get(".color.butt.bg0", "gray30"),
			Colors.white);
	Colors.butt_bg1 = disp->alloc_color(xrm->get(".color.butt.bg1", "gray90"),
			Colors.white);
	Colors.ife0_bg0 = disp->alloc_color(xrm->get(".color.ife0.bg0", "#202040"),
			Colors.white);
	Colors.ife0_bg1 = disp->alloc_color(xrm->get(".color.ife0.bg1", "#e0e0ff"),
			Colors.white);
	Colors.ife1_bg0 = disp->alloc_color(xrm->get(".color.ife1.bg0", "#203030"),
			Colors.white);
	Colors.ife1_bg1 = disp->alloc_color(xrm->get(".color.ife1.bg1", "#e0ffff"),
			Colors.white);
	Colors.ife2_bg0 = disp->alloc_color(xrm->get(".color.ife2.bg0", "#403020"),
			Colors.white);
	Colors.ife2_bg1 = disp->alloc_color(xrm->get(".color.ife2.bg1", "#ffffa0"),
			Colors.white);
	Colors.ife3_bg0 = disp->alloc_color(xrm->get(".color.ife3.bg0", "#204020"),
			Colors.white);
	Colors.ife3_bg1 = disp->alloc_color(xrm->get(".color.ife3.bg1", "#e0ffa0"),
			Colors.white);
	Colors.func_bg = disp->alloc_color(xrm->get(".color.func.bg", "gray10"),
			Colors.white);
	Colors.func_gr = disp->alloc_color(xrm->get(".color.func.gr", "gray20"),
			Colors.black);
	Colors.func_mk = disp->alloc_color(xrm->get(".color.func.mk", "red"),
			Colors.black);
	Colors.midi_bg = disp->alloc_color(xrm->get(".color.midi.bg", "gray10"),
			Colors.white);
	Colors.midi_gr1 = disp->alloc_color(xrm->get(".color.midi.gr1", "gray30"),
			Colors.black);
	Colors.midi_gr2 = disp->alloc_color(xrm->get(".color.midi.gr2", "gray70"),
			Colors.white);
	Colors.midi_co1 = disp->alloc_color(xrm->get(".color.midi.c01", "yellow"),
			Colors.white);
	Colors.midi_co2 = disp->alloc_color(xrm->get(".color.midi.c02", "green"),
			Colors.white);
	Colors.midi_co3 = disp->alloc_color(xrm->get(".color.midi.c03", "coral"),
			Colors.white);

	XftFonts.spla1 = disp->alloc_xftfont(
			xrm->get(".font.spla1", "times:bold:pixelsize=24"));
	XftFonts.spla2 = disp->alloc_xftfont(
			xrm->get(".font.spla2", "times:bold:pixelsize=16"));
	XftFonts.main = disp->alloc_xftfont(
			xrm->get(".font.main", "luxi:pixelsize=12"));
	XftFonts.large = disp->alloc_xftfont(
			xrm->get(".font.large", "times:bold:pixelsize=18"));
	XftFonts.stops = disp->alloc_xftfont(
			xrm->get(".font.stops", "times:bold:pixelsize=14"));
	XftFonts.button = disp->alloc_xftfont(
			xrm->get(".font.button", "luxi:pixelsize=12"));
	XftFonts.scales = disp->alloc_xftfont(
			xrm->get(".font.scales", "luxi:pixelsize=9"));
	XftFonts.midimt = disp->alloc_xftfont(
			xrm->get(".font.midimt", "luxi:bold:pixelsize=9"));
