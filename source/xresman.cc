...
XrmOptionDescRec X_resman::defopt[X_resman::NDEFOPT] = { {
		...
		(char *) ("-iconic"), (char *) ("*iconic"), XrmoptionNoArg,
		(char *) ("on") }, { (char *) ("-mono"), (char *) (".mono"),
		XrmoptionNoArg, (char *) ("on") }, { (char *) ("-gray"),
		(char *) (".gray"), XrmoptionNoArg, (char *) ("on") }, {
		(char *) ("-geometry"), (char *) ("*geometry"), XrmoptionSepArg, NULL },
		{ (char *) ("-background"), (char *) ("*background"), XrmoptionSepArg,
				NULL }, { (char *) ("-bg"), (char *) ("*background"),
				XrmoptionSepArg, NULL }, { (char *) ("-foreground"),
				(char *) ("*foreground"), XrmoptionSepArg, NULL }, {
				(char *) ("-fg"), (char *) ("*foreground"), XrmoptionSepArg,
				NULL }, { (char *) ("-font"), (char *) ("*font"),
				XrmoptionSepArg, NULL }, { (char *) ("-fn"), (char *) ("*font"),
...
void X_resman::init(int *argc, char *argv[], char *name, XrmOptionDescRec *opt,
		int nopt) {
	...
	av = argv;
	while (++av, --ac > 0) {
		if (!strcmp(*av, "-name") && ac > 1)
			strncpy(_rname, av[1], 64);
		if (!strcmp(*av, "-class") && ac > 1)
			strncpy(_rclas, av[1], 64);
	}
	...
	if (opt && nopt)
		XrmParseCommand(&cmd_db, opt, nopt, _rname, argc, argv);
...
int X_resman::getb(const char *res, int def) const {
	...
	val = get(res, 0);
	if (val)
		return !(strcmp(val, "on") && strcmp(val, "true") && strcmp(val, "On")
				&& strcmp(val, "True"));
	else
		return def;
}

void X_resman::geometry(const char *res, int xd, int yd, int bd, int &xp,
